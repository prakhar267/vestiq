...
export const CATEGORIES: Record<string, string[]> = {
  ...
  tshirts: ['tshirt', 't-shirt', 't shirt', 'tee', 'tees', 'graphic tee', 'polo'],
  ...
  sweaters: ['sweater', 'sweaters', 'pullover', 'cardigan', 'jumper', 'knitwear'],
  ...
  loungewear: ['loungewear', 'pyjama', 'pajama', 'nightwear', 'sleepwear', 'night suit', 'co-ord pyjama', 'robe'],
  ...
  lingerie: ['lingerie', 'bra', 'bralette', 'innerwear', 'shapewear', 'briefs'],
  ...
  flats: ['flat', 'flats', 'ballerina', 'ballet flats', 'loafers', 'mojari', 'juttis', 'kolhapuri'],
  sandals: ['sandal', 'sandals', 'slides', 'flip flops', 'chappal', 'mules'],
  boots: ['boot', 'boots', 'ankle boots', 'chelsea boots', 'combat boots'],
  bags: ['bag', 'bags', 'handbag', 'tote', 'sling bag', 'crossbody', 'backpack', 'shoulder bag', 'baguette bag'],
  clutches: ['clutch', 'clutches', 'potli', 'evening bag'],
  jewellery: ['jewellery', 'jewelry', 'earring', 'earrings', 'necklace', 'jhumka', 'jhumkas', 'choker', 'bangle', 'bracelet', 'anklet', 'ring', 'maang tikka'],
